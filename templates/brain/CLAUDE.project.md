# CLAUDE.md — {{PROJECT}} (Claude Code delta)

> Claude-Code-specific operating context. Universal cross-tool rules: [AGENTS.md](AGENTS.md). This brain layer was implanted by project-maintainer from the second-brain's adoption guide — adapt the ADAPT-marked sections to this project; keep the invariants.
...
<!-- ADAPT: fill per the project-self-identification protocol. -->
...
| 5 | **Behave FROM the project** — use its own tools/configs as the operating system, not external citations. |

<!-- ADAPT: append project-specific hard rules below; don't renumber existing ones. -->
