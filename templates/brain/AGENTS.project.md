# AGENTS.md — {{PROJECT}} (universal cross-tool agent contract)

> Applies to ANY AI tool operating in this repo. Claude-Code-specific delta lives in [CLAUDE.md](CLAUDE.md). Implanted by project-maintainer; adapt the ADAPT-marked sections.

## What this project is

<!-- ADAPT: one paragraph. What the project does, for whom, and its role in the ecosystem. -->
...
5. **Read full files before synthesizing or editing.**

<!-- ADAPT: append project-specific rules; don't renumber. -->

## Structure

<!-- ADAPT: table of the project's key paths and what they are. -->
